...
public class ConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(
                CycleButton.<WheelSearchOrder>builder(value -> Component.literal(switch (value) {
        ...
        this.addRenderableWidget(
                CycleButton.<WheelScrollDirection>builder(value -> Component.literal(switch (value) {
        ...
        this.addRenderableWidget(
                CycleButton.<ScrollItemScaling>builder(value -> Component.literal(switch (value) {
